...
class Sidebar(ui.CTkFrame):
    def __init__(self, master, **kwargs):
        ...
        self.text = ui.CTkButton(self, text="GrelinTB", command=lambda:subprocess.Popen("xdg-open https://mukonqi.github.io/grelintb/index.html", shell=True), font=ui.CTkFont(size=20, weight="bold"), fg_color="transparent", text_color=["#000000", "#FFFFFF"])
        self.version_b = ui.CTkButton(self, text=f"{l_dict['sidebar']['version'][l_use]}{version_current}", command=self.changelog, fg_color="transparent", text_color=["#000000", "#FFFFFF"])
        self.mukonqi_b = ui.CTkButton(self, text=f"{l_dict['sidebar']['developer'][l_use]}MuKonqi", command=lambda:subprocess.Popen("xdg-open https://mukonqi.github.io", shell=True), fg_color="transparent", text_color=["#000000", "#FFFFFF"])
