...
- Optimization has been done: All features now run as a separate thread. Also, the number of lines of code has been reduced from 2595 to 1963, although the interface has been greatly refreshed and beautified thanks to the use of dynamic variables and loops.
